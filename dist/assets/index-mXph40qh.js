...
`;var fa=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:`open`}),this.shadowRoot.appendChild(da.content.cloneNode(!0))}connectedCallback(){let e=this.shadowRoot.querySelector(`.rows`);e.innerHTML=la.map(e=>`
  ...
  `)}function Da(e){Ta.querySelector(`case-study-page[slug="${CSS.escape(e)}"]`)||(Ta.innerHTML=`<case-study-page slug="${e}"></case-study-page>`)}function Oa(e){wa(xa(e,e.name===`case-study`?ta(e.slug):null)),e.name===`case-study`?Da(e.slug):Ea()}Oa(ra()),aa(Oa);